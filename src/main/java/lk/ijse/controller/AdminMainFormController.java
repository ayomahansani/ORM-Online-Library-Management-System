...
public class AdminMainFormController {
    ...
    void btnBookOnAction(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/book_manage_form.fxml"));
    ...
    void btnBranchesOnAction(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/branch_manage_form.fxml"));
