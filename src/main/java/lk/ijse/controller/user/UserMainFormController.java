...
public class UserMainFormController {
    ...
    private void setDashBoardForm() throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/user/user_dashboard_form.fxml"));
    ...
    void btnBooksOnAction(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/user/user_borrowing_books_form.fxml"));
    ...
    void btnMyHistoryOnAction(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/user/borrowing_history_form.fxml"));
    ...
    void btnSettingsOnAction(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/view/user/user_details_setting_form.fxml"));
